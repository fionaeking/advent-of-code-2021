...
var points = 0;
var starts = ['[',  '(', '{', '<'] 
var endsPoints : Array<CharCount>= [{ch: ']', points: 57}, {ch: ')', points: 3}, {ch: '}', points: 1197}, {ch: '>', points: 25137}]
...
fs.readFileSync("input.txt", "utf8")
  ...
  for(let b of s.split('')) {
    ...
    {
      if (unmatchedStarts[unmatchedStarts.length-1] != starts[endsPoints.map(x => x.ch).indexOf(b)])
      {
